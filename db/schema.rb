...
ActiveRecord::Schema.define(version: 2024_08_07_062659) do
  ...
  create_table "order_taxes", force: :cascade do |t|
    ...
    t.index ["tax_type_id"], name: "index_order_taxes_on_tax_type_id"
  end
  ...
  add_foreign_key "order_taxes", "tax_types"
  ...
  add_foreign_key "tax_rates", "tax_types"
